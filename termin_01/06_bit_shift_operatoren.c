...
int main()
{
    ...
    istGerade = !(wert & 1); // Hier Ausdruck anstelle von 0 einfuegen.
    ...
    malMinusEins = ~wert + 1; // Hier Ausdruck anstelle von 0 einfuegen.
    ...
    malAcht = wert << 3; // Hier Ausdruck anstelle von 0 einfuegen.
